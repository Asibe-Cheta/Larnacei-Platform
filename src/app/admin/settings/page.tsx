...
export default function SystemSettingsPage() {
  ...
  const mockSettings: SettingsFormData = {
    ...
    contactEmail: 'info@larnaceiglobal.com',
    contactPhone: '+234 801 234 5678',
    supportEmail: 'info@larnaceiglobal.com',
    adminEmail: 'info@larnaceiglobal.com',
    maxFileSize: 10485760, // 10MB
    allowedFileTypes: ['jpg', 'jpeg', 'png', 'gif', 'pdf', 'doc', 'docx'],
    smtpHost: 'smtp.gmail.com',
    smtpPort: 587,
    smtpUser: 'info@larnaceiglobal.com',
    smtpPassword: '********',
    ...
    sendgridFromEmail: 'info@larnaceiglobal.com',
    sendgridFromName: 'Larnacei Property Platform',
    paystackSecretKey: 'your_paystack_secret_key_here',
    paystackPublicKey: 'your_paystack_public_key_here',
