...
function PropertySalesPageContent() {
  ...
  const [filters, setFilters] = useState({
    ...
    category: 'PROPERTY_SALE', // Fixed category for property sales
  ...
  const updateURL = (newFilters: typeof filters) => {
    ...
    router.push(`/properties/property-sales?${params.toString()}`);
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl font-bold text-gray-900">
              {loading ? 'Searching...' : `${pagination.total} properties for sale found`}
            </h1>
            {filters.query && (
...
function PropertySalesPageLoading() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <main className="container mx-auto px-4 py-8">
...
export default function PropertySalesPage() {
  return (
    <Suspense fallback={<PropertySalesPageLoading />}>
      <PropertySalesPageContent />
    </Suspense>
  );
} 