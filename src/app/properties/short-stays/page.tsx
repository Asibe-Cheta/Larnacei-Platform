...
function ShortStaysPageContent() {
  ...
  const [filters, setFilters] = useState({
    ...
    category: 'SHORT_STAY', // Fixed category for short stays
  ...
  const updateURL = (newFilters: typeof filters) => {
    ...
    router.push(`/properties/short-stays?${params.toString()}`);
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl font-bold text-gray-900">
              {loading ? 'Searching...' : `${pagination.total} short stay properties found`}
            </h1>
            {filters.query && (
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No short stay properties found</h3>
...
function ShortStaysPageLoading() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <main className="container mx-auto px-4 py-8">
...
export default function ShortStaysPage() {
  return (
    <Suspense fallback={<ShortStaysPageLoading />}>
      <ShortStaysPageContent />
    </Suspense>
  );
} 