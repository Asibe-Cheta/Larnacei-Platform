...
function LongTermRentalsPageContent() {
  ...
  const [filters, setFilters] = useState({
    ...
    category: 'LONG_TERM_RENTAL', // Fixed category for long term rentals
  ...
  const updateURL = (newFilters: typeof filters) => {
    ...
    router.push(`/properties/long-term-rentals?${params.toString()}`);
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl font-bold text-gray-900">
              {loading ? 'Searching...' : `${pagination.total} rental properties found`}
            </h1>
            {filters.query && (
...
function LongTermRentalsPageLoading() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <main className="container mx-auto px-4 py-8">
...
export default function LongTermRentalsPage() {
  return (
    <Suspense fallback={<LongTermRentalsPageLoading />}>
      <LongTermRentalsPageContent />
    </Suspense>
  );
} 