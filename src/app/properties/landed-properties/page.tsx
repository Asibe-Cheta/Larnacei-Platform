...
function LandedPropertiesPageContent() {
  ...
  const [filters, setFilters] = useState({
    ...
    category: 'LANDED_PROPERTY', // Fixed category for landed properties
  ...
  const updateURL = (newFilters: typeof filters) => {
    ...
    router.push(`/properties/landed-properties?${params.toString()}`);
  };
  ...
  useEffect(() => {
    fetchProperties(1);
  }, [filters.query, filters.type, filters.state, filters.city, filters.minPrice, filters.maxPrice, filters.bedrooms, filters.bathrooms, filters.sortBy, filters.sortOrder]);
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl font-bold text-gray-900">
              {loading ? 'Searching...' : `${pagination.total} landed properties found`}
            </h1>
            {filters.query && (
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No landed properties found</h3>
                <p className="text-gray-600 mb-4">
                  Try adjusting your search criteria or browse other property categories
                </p>
                <button
                  onClick={() => {
                    setFilters({
                      query: '',
                      category: 'LANDED_PROPERTY',
                      type: '',
                      state: '',
                      city: '',
                      minPrice: '',
...
function LandedPropertiesPageLoading() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <main className="container mx-auto px-4 py-8">
...
export default function LandedPropertiesPage() {
  return (
    <Suspense fallback={<LandedPropertiesPageLoading />}>
      <LandedPropertiesPageContent />
    </Suspense>
  );
} 