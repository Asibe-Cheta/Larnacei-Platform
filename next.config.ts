...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    contentSecurityPolicy: "default-src 'self' blob: data:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https:; connect-src 'self' https:;",
  },
